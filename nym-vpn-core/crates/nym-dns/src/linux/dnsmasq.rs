...
mod actor_tests {
    ...
    fn idle_snapshot_without_local_resolvers_is_the_wan_mirror() {
        ...
        assert_eq!(idle_snapshot(&paths, &idle(&[], true)), wan_snapshot(&paths));
        assert_eq!(idle_snapshot(&paths, &idle(&[], false)), wan_snapshot(&paths));
    }
    ...
    fn idle_snapshot_with_local_resolver_and_killswitch_on_drops_the_wan() {
        ...
        assert_eq!(content, "# Generated by nym-vpnd\nnameserver 10.10.10.178\n");
    }
