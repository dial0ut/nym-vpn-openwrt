...
use nym_vpn_lib_types::{
    ...
    LewesProtocolDetails, LewesProtocolDetailsData, ListGatewaysOptions, LogPath, NymNetworkDetails,
    NymVpnNetwork, Performance, QuicClientOptions, StoreAccountRequest, SystemMessage, UserAgent,
    VpnServiceInfo,
};
